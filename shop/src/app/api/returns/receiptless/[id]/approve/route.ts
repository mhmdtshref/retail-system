...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await writeAudit({ action: 'refund.create', status: 'success', actor: { id: auth.user.id, role: auth.user.role }, req, entity: { type: 'ReturnSlip', id: slip._id, code: slip.slipCode }, meta: { approve: true } });
