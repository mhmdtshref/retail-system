...
export const ROLE_PERMS: Record<Role, Action[] | ['*']> = {
  ...
  cashier: ['POS.SALE','POS.DRAWER_OPEN','POS.END_SHIFT','CUSTOMERS.CREATE','CUSTOMERS.UPDATE'],
  staff: ['INVENTORY.COUNT_POST','AUDIT.VIEW'],
  viewer: ['AUDIT.VIEW']
};

export const NEEDS_MANAGER: Action[] = [
  'POS.REFUND_CONFIRM','POS.RETURN_EXCHANGE_FINALIZE','INVENTORY.ADJUST_POST','PROMOS.MANAGE','TAX.MANAGE','PRODUCTS.DELETE','CUSTOMERS.DELETE','CUSTOMERS.MERGE'
];
