...
export const NEEDS_MANAGER: Action[] = [
  'POS.REFUND_CONFIRM','POS.RETURN_EXCHANGE_FINALIZE','INVENTORY.ADJUST_POST','PROMOS.MANAGE','TAX.MANAGE','PRODUCTS.DELETE','CUSTOMERS.DELETE','CUSTOMERS.MERGE','NOTIF.MANAGE'
];
